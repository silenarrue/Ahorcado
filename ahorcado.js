...
function recorridoArray(palabra){
  var palabra = prompt("introducir una palabra", "aqui");
  var str = palabra.split("").join();
  var s = [];
...
var e = obtienerPalabraSecreta();
var r = recorridoArray();

function comparar(r, e){
      var intentos = 0;
  if(r == e){
